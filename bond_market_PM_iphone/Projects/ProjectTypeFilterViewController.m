//
//  ProjectTypeFilterViewController.m
...
@interface ProjectTypeFilterViewController ()

@end

@implementation ProjectTypeFilterViewController

- (id)init
{
    self = [super init];
    if (self) {
        QRootElement *root = [[QRootElement alloc]initWithJSONFile:@"ProjectTypeFilterDataBuilder" andData:nil];
...
- (void)filterProjects
{
    ...
    NSDictionary* info = [NSDictionary dictionaryWithObject:dic[@"query"] forKey: BYPROJECTTYPEFILTERQUERY];
...
- (void)setUpSeletedRole
{
    ...
    __block ProjectTypeFilterViewController *_self = self;
